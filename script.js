...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function loadToDoListFromLocalStorage() {
    const savedToDoListItems = localStorage.getItem("toDoListItems");
    if (savedToDoListItems) {
      toDoListItems = JSON.parse(savedToDoListItems);
    }
  }

  // Function to save the To-Do list items to local storage
